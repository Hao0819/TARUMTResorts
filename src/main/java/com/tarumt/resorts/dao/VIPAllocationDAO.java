...
public class VIPAllocationDAO {
    ...
    public ListQueueInterface<VIPAllocationRequest> getAllRequests(
        ...
        String[][] sampleData = {
            // Req ID,   Guest ID, Request Time,        Room Type,  Status
            { "VR0001", "G006", "2026-07-20 08:05", "Suite",    "ASSIGNED" },
            { "VR0002", "G011", "2026-07-20 08:20", "Deluxe",   "ASSIGNED" },
            { "VR0003", "G004", "2026-07-20 09:00", "Standard", "CANCELLED" },
            { "VR0004", "G012", "2026-07-20 09:30", "Suite",    "WAITING" },
            { "VR0005", "G005", "2026-07-20 09:45", "Deluxe",   "WAITING" },
            { "VR0006", "G010", "2026-07-20 10:00", "Standard", "WAITING" },
            { "VR0007", "G004", "2026-07-20 10:15", "Deluxe",   "WAITING" }
        };
